...
public interface Annoncerepository extends JpaRepository<Annonce,Integer> {
    ...
    @Query("SELECT a FROM Annonce a WHERE a.prix BETWEEN :minPrix AND :maxPrix or a.marque.idmarque= :idmarque  or a.modele=:modele or a.categorie.idCategorie= :idcategorie")
